...
public class FreecellMultimoveModelTest {
  ...
  public void moveCascadeToCascade() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 2, false);
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.CASCADE,
            2);
    assertEquals(s12, freecellMultimoveModel.getCascadeCardAt(2, 13));
  ...
  public void moveCascadeToOpen() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 2, false);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 12, PileType.OPEN,
            0);
    assertEquals(h11, freecellMultimoveModel.getOpenCardAt(0));
  ...
  public void moveCascadeToFoundation() {
    ...
    freecellMultimoveModel.move(PileType.CASCADE, 3, 12, PileType.FOUNDATION,
            2);
    assertEquals(c1, freecellMultimoveModel.getFoundationCardAt(2, 0));
  ...
  public void moveOpenToFoundation() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 2, false);
    freecellMultimoveModel.move(PileType.CASCADE, 3, 12, PileType.OPEN,
            1);
    freecellMultimoveModel.move(PileType.OPEN, 1, 0, PileType.FOUNDATION,
            1);
    assertEquals(c1, freecellMultimoveModel.getFoundationCardAt(1, 0));
  ...
  public void moveOpenToCascade() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 2, false);
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.OPEN,
            0);
    freecellMultimoveModel.move(PileType.OPEN, 0, 0, PileType.CASCADE,
            2);
    assertEquals(s12, freecellMultimoveModel.getCascadeCardAt(2, 13));
  ...
  public void moveFromFoundation() {
    ...
    freecellMultimoveModel.move(PileType.CASCADE, 3, 12, PileType.FOUNDATION,
            0);
    freecellMultimoveModel.move(PileType.FOUNDATION, 0, 0, PileType.CASCADE,
            2);
  ...
  public void multiMoveNonEmptyCascade() {
    freecellMultimoveModel.startGame(validDeck, 8, 4, false);
    ...
    freecellMultimoveModel.move(PileType.CASCADE, 0, 6, PileType.FOUNDATION,
            0);
    freecellMultimoveModel.move(PileType.CASCADE, 5, 5, PileType.CASCADE,
            4);
    freecellMultimoveModel.move(PileType.CASCADE, 6, 5, PileType.CASCADE,
            4);
    freecellMultimoveModel.move(PileType.CASCADE, 4, 5, PileType.CASCADE,
            3);
    assertEquals(h9, freecellMultimoveModel.getCascadeCardAt(3, 5));
    assertEquals(c8, freecellMultimoveModel.getCascadeCardAt(3, 6));
    assertEquals(h7, freecellMultimoveModel.getCascadeCardAt(3, 7));
    assertEquals(c6, freecellMultimoveModel.getCascadeCardAt(3, 8));

  }

  @Test
  public void multiMove1EmptyCascade() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 4, false);
    freecellMultimoveModel.move(PileType.CASCADE, 3, 12, PileType.FOUNDATION,
            0);
    ...
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.CASCADE,
            2);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 12, PileType.CASCADE,
            2);

    freecellMultimoveModel.move(PileType.CASCADE, 2, 12, PileType.CASCADE,
            3);

    assertEquals(d13, freecellMultimoveModel.getCascadeCardAt(3, 0));
    assertEquals(s12, freecellMultimoveModel.getCascadeCardAt(3, 1));
    assertEquals(h11, freecellMultimoveModel.getCascadeCardAt(3, 2));


  }

  @Test(expected = IllegalArgumentException.class)
  public void multiMoveCascadeBad() {
  ...
  public void multiMoveOpenBad() {
    ...
    freecellMultimoveModel.move(PileType.CASCADE, 2, 12, PileType.OPEN,
            1);

  }

  @Test(expected = RuntimeException.class)
  public void multiMoveFoundationBad() {
    freecellMultimoveModel.startGame(validDeck, 4, 4, false);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 12, PileType.CASCADE,
            1);
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.CASCADE,
  ...
  // create invalid build
  @Test(expected = Exception.class)
  public void moveInvalidBuild() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 1, false);
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.CASCADE,
            2);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 12, PileType.CASCADE,
            2);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 11, PileType.CASCADE,
            2);

  }

  // try to move invalid build
  @Test(expected = Exception.class)
  public void invalidBuild() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 1, false);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 10, PileType.CASCADE,
            1);

  }

  // build too big for equation
  @Test(expected = IllegalArgumentException.class)
  public void breakEquation() {
    freecellMultimoveModel.startGame(multiDeck1, 4, 1, false);
    freecellMultimoveModel.move(PileType.CASCADE, 1, 12, PileType.CASCADE,
            2);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 12, PileType.CASCADE,
            2);
    freecellMultimoveModel.move(PileType.CASCADE, 0, 11, PileType.OPEN,
            0);
    freecellMultimoveModel.move(PileType.CASCADE, 2, 12, PileType.CASCADE,
            3);
